...
from ventanas.video_reproductor.visor_player import VisorPlayer
from ventanas.video_reproductor.fmc import Controles
...
rz.geometry("320x210")
vd1= "VOCALE.mp4"
vp = MiPlayerMPV(rz,60)
vp.reproduce(vd1,'00:00:00')
